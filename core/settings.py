...
# The default storage handles uploaded media files.
# The staticfiles storage uses WhiteNoise for compressed static files.
...
# Email configuration
# Values are loaded from environment variables for local and production use.
